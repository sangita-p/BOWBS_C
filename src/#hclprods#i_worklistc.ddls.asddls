@AbapCatalog.sqlViewName: '/HCLPRODS/IWLC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Work List'
@VDM.viewType: #CONSUMPTION
@UI.headerInfo: { typeNamePlural: 'Work List' }                              //For Table Title in Work List Table

define view /HCLPRODS/I_WorkListC
  as select from /HCLPRODS/I_WorkListEventc as _event
  association [0..1] to /HCLPRODS/I_BowCommercialInfoc as _comm on _comm.Notification = _event.Notification
  association        to parent /HCLPRODS/C_Bow_c        as _bow  on _bow.bowid = $projection.bowid
{
