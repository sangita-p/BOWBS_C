@AbapCatalog.sqlViewName: '/HCLPRODS/CBOWHC'
...
define root view /HCLPRODS/C_Bow_c
  as select from /HCLPRODS/I_Bow as _bowh
  association [0..1] to /HCLPRODS/C_BowStatusVc as _status_text on _status_text.Low = _bowh.status
  //  association [0..1] to /HCLPRODS/C_BowTypeVH   as _type_text   on _type_text.Low = _bowh.bowty
  association [0..1] to /HCLPRODS/C_BowTypeVc   as _type_text   on _type_text.bowty = _bowh.bowty
  composition [0..*] of /HCLPRODS/I_WorkListC    as _wl
{
        @UI: {
  ...
  key   _bowh.bowid,
        ...
        @Consumption.valueHelpDefinition: [{ entity: { name: '/HCLPRODS/C_BowTypeVH', element: 'bowty'}}]
        @EndUserText.label: 'Type'
        @ObjectModel.text.element: ['Type_Description']
        ...
        @UI.hidden: true
        _type_text.description                 as Type_Description,
        //Associations
        _wl
}
