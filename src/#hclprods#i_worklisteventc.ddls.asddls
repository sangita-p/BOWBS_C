@AbapCatalog.sqlViewName: '/HCLPRODS/WLEVNC'
@AbapCatalog.compiler.compareFilter: true
@AbapCatalog.preserveKey: true
@AccessControl.authorizationCheck: #CHECK
@EndUserText.label: 'Work List Event Info'

define view /HCLPRODS/I_WorkListEventc
  as select from /HCLPRODS/I_BowLinkedRevisionc as _diwps
  ...
  association [0..*] to plko   as _plko on _plko.plnty = _diwps.TaskListType
                                       and _plko.plnnr = _diwps.TaskListGroupKey
                                       and _plko.plnal = _diwps.GroupCounter
{
  key  _diwps.bowid,
       _diwps.Plant,
       _diwps.Revision,
       ...
       _plko.ktext                            as TaskListDescription
}
